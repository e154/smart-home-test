...
func (n *Entity) DeleteScripts(ctx context.Context, entityID common.EntityId) (err error) {
	err = n.table.DeleteScripts(ctx, entityID)
	return
}

func (n *Entity) DeleteTags(ctx context.Context, entityID common.EntityId) (err error) {
